...
jobBox.id = 'job';
jobBox.innerHTML = 'Clown and Restaurantuer';
...
hobbyElem.id = 'hobbies';
hobbyElem.innerHTML = 'Long romantic walks on the beach, candle light Big Mac dinners and tormenting the King.';
data.appendChild(hobbyElem);
...
proBox.id = 'pro2';
proBox.innerHTML = 'I love making people laugh with my awesome jokes.  I wish to share my jokes with a new girlfriend.';
